...
- (void)checkInitialization {
    self.FRHyperLabelLinkColorDefault = [UIColor blueColor];
    self.FRHyperLabelLinkColorHighlight = [UIColor blueColor];
	...
	if (!self.linkAttributeDefault) {
		self.linkAttributeDefault = @{NSForegroundColorAttributeName: _FRHyperLabelLinkColorDefault,
									  };
	}
	
	if (!self.linkAttributeHighlight) {
		self.linkAttributeHighlight = @{NSForegroundColorAttributeName: _FRHyperLabelLinkColorHighlight,
										};
	}
}
